...
def record(ip: str, filename: str, freq: int, audio_device: str, record_folder: str, record_audio: bool) -> None:
    mini = ReachyMini()
...
def main():
    ...
    record(args.ip, args.name, args.freq, args.audio_device, args.record_folder, not args.no_audio)
